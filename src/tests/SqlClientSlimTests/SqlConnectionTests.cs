...
namespace System.Data.SqlClient.Tests
{
    public class SqlConnectionTests
    {
        ...
        {
            string connectionString = Utilities.SqlAuthConnectionString + "max pool size = 1";
        ...
        {
            string badCredentialConnectionString = new SqlConnectionStringBuilder(Utilities.SqlAuthConnectionString) { UserID = "NotAUser", Password = "BadPassword" }.ToString();
